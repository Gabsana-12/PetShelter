...
namespace PetShelter.Tests.Services
{
    ...
    {
        private readonly Mock<IPetsTypeRepository> _pettypeRepositoryMock = new Mock<IPetsTypeRepository>();
        private readonly IPetTypeService _service;
        private PetTypeDto pettype;

        public PetTypeServiceTest()
        {
            _service = new PetsTypeService(_pettypeRepositoryMock.Object);
        }
