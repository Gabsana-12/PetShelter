...
{
    public class PetVaccineServiceTest
    {
        private readonly Mock<IPetsVaccineRepository> _petvaccineRepositoryMock = new Mock<IPetsVaccineRepository>();
        private readonly IPetVaccineService _service;
        private PetVaccineDto petvaccine;

        public PetVaccineServiceTest()
        {
            _service = new PetsVaccineService(_petvaccineRepositoryMock.Object);
        }
